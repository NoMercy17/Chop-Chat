  ...
  return (
    <View style={[styles.header, { backgroundColor: theme.screenBackground }]}>
      ...
      <View style={styles.profileImageContainer}>
        ...
        {profilePhoto ? (
          <Image source={{ uri: profilePhoto }} style={[styles.profileImage, { borderColor: theme.primary }]} />
        ) : (
          <View style={[styles.profileImage, styles.avatarPlaceholder, { backgroundColor: theme.primary, borderColor: theme.primary }]}>
            <Text style={[styles.avatarInitials, { color: theme.textInverse }]}>{getInitials(name)}</Text>
          </View>
        )}
        <Pressable style={[styles.editImageBadge, { backgroundColor: theme.primary, borderColor: theme.screenBackground }]} onPress={onEditImage} disabled={isUploading}>
