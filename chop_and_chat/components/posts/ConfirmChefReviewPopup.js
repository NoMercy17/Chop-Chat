...
export default function ConfirmChefReviewPopup({ visible, onConfirm, onCancel, onClose, loading, chefFilter, statusLabel }) {
    ...
    // Android hardware back button triggers onRequestClose — block it during upload.
    return (
        <Modal
            visible={visible}
            transparent={true}
            ...
            >
                ...
                >
                    <View style={[styles.iconPill, { backgroundColor: theme.primaryLighter }]}>
                        <Ionicons name="ribbon" size={fp(28)} color={theme.primary} />
                    </View>
                    ...
                    <Text style={[styles.subtitle, { color: theme.textSecondary }]}>
                        Your request will be sent to {audienceLabel}. A chef will review your dish and provide professional feedback.
                    </Text>
