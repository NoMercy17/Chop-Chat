...
// Build fetch URL from server-side env values only — nothing from user input.
...
// Falls back to the next model only on 429/503 — other errors re-thrown immediately.
