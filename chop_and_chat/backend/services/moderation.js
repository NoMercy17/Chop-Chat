// Local pattern-based moderation — synchronous, zero latency, no external API.
// Policy: block the "really hard stuff" only. Banter, trash talk, hard jokes, and
// swearing are intentionally allowed.
